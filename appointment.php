  ...
  <?php if ($showModal == true) : ?>
      <div id="modal" class="w-full h-[100%] fixed bg-black/50 backdrop-blur-[5px] z-[999] flex items-center justify-center">
          <form class="rounded-[4px] bg-white p-[30px] flex flex-col w-full max-w-[540px] gap-[30px]">
              <h3 class="font-bold text-[40px]">Appointment Scheduled</h3>
              <div class="flex flex-col gap-[10px]">
                  <div class="flex flex-col">
                      <h4 class="font-medium text-[18px]">Date:</h4>
                      <p class="font-regular text-gray-600 text-[18px]">28 September 2025</p>
                  </div>
                  <div class="flex flex-col">
                      <h4 class="font-medium text-[18px]">Time:</h4>
                      <p class="font-regular text-gray-600 text-[18px]">10:30 AM</p>
                  </div>
                  <div class="flex flex-col">
                      <h4 class="font-medium text-[18px]">Service:</h4>
                      <p class="font-regular text-gray-600 text-[18px]">Blood Test</p>
                  </div>
                  <div class="flex flex-col">
                      <h4 class="font-medium text-[18px]">Location:</h4>
                      <p class="font-regular text-gray-600 text-[18px]">123 Mabini Street,
                          <br>
                          Barangay San Isidro,
                          <br>
                  ...
                  <div class="flex flex-col">
                      <h4 class="font-medium text-[18px]">Practitioner:</h4>
                      <p class="font-regular text-gray-600 text-[18px]">Dr. Maria Santos
                      </p>
                  </div>
              </div>
              <button class="w-full flex items-center justify-center px-[20px] py-[10px] text-[20px] bg-[#EA580C] text-[#ffffff] font-medium rounded-[4px] border-[1px] border-[#EA580C] hover:bg-orange-700 transition-all duration-300 hover:cursor-pointer">My Appointments</button>
          </form>
      </div>
  <?php endif ?>
  <body class="relative">
      ...
      <main class="w-full h-[100vh] pl-[290px] pr-[20px] flex flex-col gap-[30px] transition-all duration-300">
          <div class="flex w-full items-start justify-between py-[25px] border-b-[1px] border-[#D4D4D8]">
              <div class="flex items-center gap-[10px] max-w-[579px]">
                  <div class="flex flex-col">
                      <h1 class="font-serif font-medium text-[35px]">Medical Appointment</h1>
                  ...
                  <div id="notifSched" class="w-full hidden flex-col">
                      <div class="group relative w-full justify-between flex items-center border-solid border-b-[1px] px-[0px] border-[#E4E4E7] py-[15px]">
                          ...
                          <div class="margin-left-auto flex">
                              ...
                              <!-- Action -->
                              <div class="action-box absolute bottom-0 right-0 mb-[-70px] z-[99] mr-[30px] hidden flex-col gap-[10px] rounded-[4px] border-[1px] bg-white border-[#D4D4D8] p-[15px]">
