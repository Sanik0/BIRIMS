      ...
      <nav class="w-full">
          <div class="w-full flex flex-col">
              <a href="index.php" class="group flex gap-[10px] items-center py-[10px]">
                  <svg class="h-[30px] w-[30px] <?= ($current_page == 'index.php') ? 'fill-[#ea580c]' : 'group-hover:fill-[#71717A] fill-[#A1A1AA]'; ?> transition-all duration-300 " xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
                      <path d="M520-600v-240h320v240H520ZM120-440v-400h320v400H120Zm400 320v-400h320v400H520Zm-400 0v-240h320v240H120Z" />
                  </svg>
                  <div class="font-semibold text-[20px] <?= ($current_page == 'index.php') ? 'text-[#ea580c]' : 'group-hover:text-[#71717A] text-[#A1A1AA]'; ?> transition-all duration-300">Dashboard</div>
              </a>
              ...
              <a href="users.php" class="group flex gap-[10px] items-center py-[10px]">
                  <svg class="h-[30px] w-[30px]  <?= ($current_page == 'users.php') ? 'fill-[#ea580c]' : 'group-hover:fill-[#71717A] fill-[#A1A1AA]'; ?> transition-all duration-300" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
                      <path d="M40-160v-112q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q66 0 130 15.5T616-378q29 15 46.5 43.5T680-272v112H40Zm720 0v-120q0-44-24.5-84.5T666-434q51 6 96 20.5t84 35.5q36 20 55 44.5t19 53.5v120H760ZM360-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47Zm400-160q0 66-47 113t-113 47q-11 0-28-2.5t-28-5.5q27-32 41.5-71t14.5-81q0-42-14.5-81T544-792q14-5 28-6.5t28-1.5q66 0 113 47t47 113Z" />
                  </svg>
                  <div class="font-semibold text-[20px]  <?= ($current_page == 'users.php') ? 'text-[#ea580c]' : 'group-hover:text-[#71717A] text-[#A1A1AA]'; ?> transition-all duration-300">Users</div>
              </a>
              <a href="orders.php" class="  group flex gap-[10px] items-center py-[10px]">
                  ...
                  <div class="font-semibold text-[20px] <?= ($current_page == 'orders.php') ? 'text-[#ea580c]' : 'group-hover:text-[#71717A] text-[#A1A1AA]'; ?> transition-all duration-300">Orders</div>
              </a>
              ...
              <a href="appointments.php" class="group flex gap-[10px] items-center py-[10px]">
                  <svg class="h-[30px] w-[30px] <?= ($current_page == 'appointments.php') ? 'fill-[#ea580c]' : 'group-hover:fill-[#71717A] fill-[#A1A1AA]'; ?> transition-all duration-300" xmlns="http://www.w3.org/2000/svg" height="24px"
                      viewBox="0 -960 960 960" width="24px" fill="#EFEFEF">
                      <path
                  ...
                  <div class="font-semibold text-[20px] <?= ($current_page == 'appointments.php') ? 'text-[#ea580c]' : 'group-hover:text-[#71717A] text-[#A1A1AA]'; ?> transition-all duration-300">Appointments</div>
              </a>
              <a href="verifications.php" class="group flex gap-[10px] items-center py-[10px]">
                  <svg class="h-[30px] w-[30px] <?= ($current_page == 'verifications.php') ? 'fill-[#ea580c]' : 'group-hover:fill-[#71717A] fill-[#A1A1AA]'; ?> transition-all duration-300" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
                  ...
                  <div class="font-semibold text-[20px] <?= ($current_page == 'verifications.php') ? 'text-[#ea580c]' : 'group-hover:text-[#71717A] text-[#A1A1AA]'; ?> transition-all duration-300">Verification</div>
              </a>
          </div>
      </nav>
  </section>