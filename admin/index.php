        ...
        <main class="w-full h-[100vh] pl-[290px] pr-[20px] flex flex-col gap-[30px] transition-all duration-300">
            <div class="flex w-full items-start justify-between py-[25px] border-b-[1px] border-[#D4D4D8]">
                <div class="flex items-center gap-[10px] max-w-[579px]">
                    <div class="h-[90px] min-w-[90px] max-w-[90px] rounded-[50%] overflow-hidden">
                    ...
                    <div class="flex flex-col">
                        <h1 class="font-serif font-medium text-[35px]">Welcome, John Doe!</h1>
            ...
            <section class="w-full items-center gap-[37px] flex-col flex">
                <div class="w-full flex items-center justify-between">
                    <div class="rounded-[4px] p-[15px] flex flex-col gap-[13px] border-[1px] border-gray-300">
                        <div class="flex items-center gap-[90px] py-[5px] border-b-gray-300 border-b-[1px]">
                    ...
                    <div class="rounded-[4px] p-[15px] flex flex-col gap-[13px] border-[1px] border-gray-300">
                        <div class="flex items-center gap-[90px] py-[5px] border-b-gray-300 border-b-[1px]">
                            ...
                            <div class="flex flex-col items-end">
                                <p class="text-gray-600 font-regular text-[18px]">Appointments</p>
                                <h1 class="text-[30px] font-medium">887</h1>
                            </div>
                        </div>
                        <div class="w-full flex items-center gap-[15px]">
                ...
                <div class="w-full flex items-center justify-between gap-[37px]">
                    <div class="rounded-[4px] h-[368px] flex flex-col gap-[10px] w-full max-w-[703px] fit px-[30px] py-[20px] border-[1px] border-gray-300">
                        <div class="flex flex-col">
                            <h1 class="text-[25px] font-medium">Barangay Blotter Rerports</h1>
                            <p class="text-gray-500 ">Reports in the past year</p>
                        </div>
                        <div class="flex w-full items-center py-[20px] gap-[64px] h-full">
                            <div class="h-full w-[194px]">
                    ...
                    <div class="rounded-[4px] h-[368px] flex flex-col gap-[10px] w-full max-w-[500px] fit px-[30px] py-[20px] border-[1px] border-gray-300">
                        <div class="flex flex-col">
