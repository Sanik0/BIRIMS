            ...
            <div class="flex w-full items-start justify-between py-[25px] border-b-[1px] border-[#D4D4D8]">
                <div class="flex items-center gap-[10px] max-w-[579px]">
                    <div class="flex flex-col">
                        <h1 class="font-serif font-medium text-[35px]">Barangay Certificate Of Residency</h1>
                ...
                <div class="rounded-[4px] w-full max-w-[990px] border-gray-300 border-[1px] px-[35px] py-[20px] mb-[]">
                    ...
                    <div class="flex flex-col w-full gap-[50px] py-[30px]">
                        ...
                        <div class="w-full flex items-center gap-[60px]">
                            <div class="rounded-[4px] border-[1px] border-[#B8FB3C] w-full bg-[#F2FFD5] flex items-center justify-center flex-col gap-[25px] max-w-[320px] px-[15px] py-[20px]">
