    ...
    <body class="relative">
        ...
        <main class="w-full h-[100vh] pl-[290px] pr-[20px] flex flex-col gap-[30px] transition-all duration-300">
            <div class="flex w-full items-start justify-between py-[25px] border-b-[1px] border-[#D4D4D8]">
                <div class="flex items-center gap-[10px] max-w-[579px]">
                    <div class="flex flex-col">
                        <h1 class="font-serif font-medium text-[35px]">File A Blotter Report</h1>
            ...
            <section class="w-full items-center justify-center flex">
                <div class="rounded-[4px] w-full max-w-[990px] border-gray-300 border-[1px] px-[35px] py-[20px]">
                    <div class="border-b-[1px] pb-[10px] flex flex-col gap-[30px] relative">
                        <div class="rounded-[50%] h-[100px] w-[100px] overflow-hidden absolute left-0">
                    ...
                    <form class="w-full flex flex-col gap-[15px] mt-[30px]" action="">
                        ...
                        <div class="flex items-center gap-[10px] w-full max-w-[700px]">
                        ...
                        <div class="flex items-center gap-[10px] w-full max-w-[500px]">
