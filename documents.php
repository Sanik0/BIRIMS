            ...
            <main class="w-full h-[100vh] pl-[290px] pr-[20px] flex flex-col gap-[30px] transition-all duration-300">
                <div class="flex w-full items-start justify-between py-[25px] border-b-[1px] border-[#D4D4D8]">
                    <div class="flex items-center gap-[10px] max-w-[579px]">
                        <div class="flex flex-col">
                            <h1 class="font-serif font-medium text-[35px]">Request Documents</h1>
                ...
                <section>
                    <div class="w-full flex flex-col gap-[15px]">
                        <h3 class="font-serif text-[30px] font-medium">Request Documents</h3>
                        <div class="w-full flex justify-between flex-wrap gap-[46px] mb-[30px]">
                            <div
