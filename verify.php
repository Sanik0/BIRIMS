            ...
            <div class="flex w-full items-start justify-between py-[25px] border-b-[1px] border-[#D4D4D8]">
                <div class="flex items-center gap-[10px] max-w-[579px]">
                    <div class="flex flex-col">
                        <h1 class="font-serif font-medium text-[35px]">Verify Account</h1>
            ...
            <section class="w-full items-center justify-center flex">
                <!-- <div class="flex w-full max-w-[948px] flex-col gap-[30px] mb-[30px]">
                    <div class="flex w-full gap-[30px]">
                        <svg class="w-[290px] h-[190px]" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flex flex-col gap-[30px] w-full">
                        <a href="#" class="w-full flex items-center gap-[8px] rounded-[4px] border-[1px] border-gray-400 p-[10px] group">
                            <svg class="h-[70px] w-[70px] fill-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
                ...
                <div class=" max-w-[792px] flex flex-col gap-[20px] rounded-[4px] border-solid border-[1px] border-gray-300 p-[30px]">
                    ...
                    <div class="w-full max-w-[481px] h-[287px] overflow-hidden rounded-[4px]">
