     ...
     <main class="w-full h-[100vh] sm:pl-[290px] sm:pr-[20px] flex flex-col gap-[30px] transition-all duration-300">
         <div class="flex w-full items-start justify-between py-[25px] border-b-[1px] border-[#D4D4D8] px-[15px] sm:px-[0]">
             <div class="flex items-center gap-[10px] max-w-[579px]">
                 <div class="rounded-[50%] hidden sm:flex  h-[98px] w-[98px] min-w-[98px] bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center">
                 ...
                 <div class="flex flex-col">
                     ...
                     <p class="sm:text-[16px] text-[14px] font-medium text-[#A1A1AA]">
                         Manage user records, appointments, and system activity all in one place.
                     </p>
                 </div>
             </div>
