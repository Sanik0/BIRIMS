              ...
              <main class="w-full h-[100vh] sm:pl-[290px] sm:pr-[20px] flex flex-col gap-[30px] transition-all duration-300">
                  ...
                  <section class="w-full flex px-[15px] sm:p-[0] flex-col gap-[15px]">
                      <div class="w-full flex-col sm:flex-row items-start gap-[10px] sm:gap-[0] sm:items-center justify-start flex">
                          <form method="GET" action="{{ route('admin.orders.index') }}" class="flex w-full flex-col sm:flex-row sm:w-fit gap-[20px]">
                              <div class="flex items-center w-fit rounded-[4px] px-[8px] py-[10px] border-[1px] border-gray-400 text-[18px] font-normal text-gray-400 gap-[8px]">
                                  ...
                                  <select class="appearance-none focus:outline-none" name="status">
                              ...
                              <div class="flex items-center w-full gap-[10px]">
                                  ...
                                  <div class="flex items-center rounded-[4px] px-[8px] py-[10px] border-[1px] w-full sm:w-[308px] border-gray-400 text-[18px] font-normal text-gray-600 gap-[8px]">
                                      ...
                                      <input class="w-full focus:outline-none" placeholder="Search" type="search" name="search" value="{{ request('search') }}">
                                  </div>
