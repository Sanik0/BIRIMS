  ...
  <section
    ...
    <nav class="w-full">
      <div class="{{url('/home')}} flex flex-col">
        <a href="index.php" class="group flex gap-[10px] items-center py-[10px]">
          <svg class="h-[30px] w-[30px]           
           {{request()->is('home') ? 'fill-[#ea580c]' : 'group-hover:fill-[#71717A] fill-[#A1A1AA]'}} 
        ...
        <a href="verifications.php" class="group flex gap-[10px] items-center py-[10px]">
          <svg class="h-[30px] w-[30px] 
              {{request()->is('verification') ? 'fill-[#ea580c]' : 'group-hover:fill-[#71717A] fill-[#A1A1AA]'}} transition-all duration-300" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
