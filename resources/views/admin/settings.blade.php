       ...
       <div id="modal" class="w-full modal fixed inset-0 overflow-y-auto p-[15px] sm:p-[50px] bg-black/50 backdrop-blur-[5px] z-[999] hidden justify-center">
           <form method="POST" action="{{ route('admin.profile.update') }}" class="rounded-[4px] h-fit bg-white p-[15px] sm:p-[30px] flex flex-col w-full max-w-[540px] gap-[30px]">
               @csrf
               @method('PUT')
       ...
       <div id="pwdModal" class="w-full modal fixed inset-0 overflow-y-auto p-[15px] sm:p-[50px] bg-black/50 backdrop-blur-[5px] z-[999] hidden items-center justify-center">
           <form method="POST" action="{{ route('admin.password.update') }}" class="rounded-[4px] h-fit bg-white p-[15px] sm:p-[30px] flex flex-col w-full max-w-[540px] gap-[30px]">
               @csrf
               @method('PUT')
       ...
       <body class="relative">
           ...
           <script>
               document.addEventListener('DOMContentLoaded', function() {
                   ...
                   // Change password modal
                   if (openPwdBtn && pwdModal && pwdCancelBtn) {
                   ...
                   // Delete account modal
                   if (deleteAccBtn && deleteAccModal && cancelDeleteBtn) {
